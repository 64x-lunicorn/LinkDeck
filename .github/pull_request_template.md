<!-- CI runs Lint, Test, Build, Security audit, Workflow lint and Secret scan, and ends in the CI gate. Run `npm run ci` before pushing to get the same answer without a round trip. -->
